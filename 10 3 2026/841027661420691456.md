---
title: From \#news (`1464347959310291175`) in Altare (`841027661420691456`)
---

<DateDisplay timestamp="1773145972123" />  
...
<DateDisplay timestamp="1772825970695" />  
_tom.m7 (tom.m7, `1230563250752458753`)_
> @here If you can't log in to [control.altare.sh](https://control.altare.sh/) due to dashboard issues and need to back up your data, please open a ticket and include your Altare email.
> 
> We are currently working on a new and much more stable dashboard by @nadhi (nothingwhere_wht2, `1411742194582421656`) and @Brewed (brewed_sys, `760438064971251753`) everything will be reset once the new dashboard is finished.
>
...
> 
> Plus we are releasing exact scores on benchmarks + the process for Arc 6 Max, Arc 6, Arc 6 mini, Arc 6 nano[archive/assets/messages/attachment_1477551450220658813](archive/assets/messages/attachment_1477551450220658813)
>
...
_Ether (ethpr, `1049816501567373383`)_
> you too[archive/assets/messages/attachment_1477352554282352743](archive/assets/messages/attachment_1477352554282352743)
>
...
_Brewed (brewed_sys, `760438064971251753`)_
> Llama 4 Maverick 17B 128E model will be removed from arc chat on March 9th, 2026[archive/assets/messages/attachment_1477068911513178142](archive/assets/messages/attachment_1477068911513178142)
>
...
> 
> We are changing our brand lineup to make things more clear, and focus on each brand's core products. Workstations will become Desktops and remain available for free from Aztec upon its launch[archive/assets/messages/attachment_1476611277311967242](archive/assets/messages/attachment_1476611277311967242)
>
...
> 
> Please create a ticket!![archive/assets/messages/attachment_1475930240780865687](archive/assets/messages/attachment_1475930240780865687)
>
...
> 
> Please create a #tickets (`1466108983734567180`)[archive/assets/messages/attachment_1475928850289397780](archive/assets/messages/attachment_1475928850289397780)
>
...
_JulianRJC (julianrjc, `1369710606319489096`)_
> SECOND WINNNNERRR ISSSS!!! @Wobbie (wobbie0862_64759, `1179474294670118935`)[archive/assets/messages/attachment_1475928273203757178](archive/assets/messages/attachment_1475928273203757178)
>
...
_JulianRJC (julianrjc, `1369710606319489096`)_
> @KINGSIPU (sipukingop., `1345329283454861342`) YOUR THE WINNNERRRRRRRRRRRR!!! Create a ticket to claim your credits and tag \<@1066059824346955886>[archive/assets/messages/attachment_1475927337303543838](archive/assets/messages/attachment_1475927337303543838)
>
...
> 
> For now, here's the openapi.json for them. Workstations/VMs will be fixed soon I'm going to bed it's 6 am and I haven't slept[archive/assets/messages/attachment_1475384011668066538](archive/assets/messages/attachment_1475384011668066538)
> [archive/assets/messages/attachment_1475384011957207082](archive/assets/messages/attachment_1475384011957207082)
>
...
> 
> Performance and latency is excellent no matter where you are, thanks to all of our nodes and VM hypervisors now being powered by Altare's network (AS215327)[archive/assets/messages/attachment_1474048115035344918](archive/assets/messages/attachment_1474048115035344918)
>

<DateDisplay timestamp="1771449313948" />  
_Ether (ethpr, `1049816501567373383`)_
> I promise you've all never experienced such a smooth and responsive UI on Altare before[archive/assets/messages/attachment_1473789983860068383](archive/assets/messages/attachment_1473789983860068383)
>

<DateDisplay timestamp="1771449244893" />  
_Ether (ethpr, `1049816501567373383`)_
> @everyone Say hello to Altare 10. Coming 20 Feb, 14:00 BST. It's finally here, no more delays[archive/assets/messages/attachment_1473789694423597066](archive/assets/messages/attachment_1473789694423597066)
>
...
_Ether (ethpr, `1049816501567373383`)_
> whats this[archive/assets/messages/attachment_1470987948320100422](archive/assets/messages/attachment_1470987948320100422)
>
...
> 
> https://github.com/altaresoftware/na1-apps/releases/tag/1.1.0[archive/assets/messages/attachment_1470445026592035089](archive/assets/messages/attachment_1470445026592035089)
>
...
_Ether (ethpr, `1049816501567373383`)_
> **This really doesn't work properly on Windows 10 right now.** We only tested it on macOS and Windows 11[archive/assets/messages/attachment_1470226694773276722](archive/assets/messages/attachment_1470226694773276722)
>
...
> 
> The code for the app is fully open source, just look inside desktop/ of that repo[archive/assets/messages/attachment_1470223203753398355](archive/assets/messages/attachment_1470223203753398355)
>
...
> 
> https://na1.host[archive/assets/messages/attachment_1466497367522935080](archive/assets/messages/attachment_1466497367522935080)
>
...
> 
> Not much else to say about it but v0.1.0 will release next week with full documentation plus Bunker. We would like to launch it with all of the necessary packages to build a basic API, HTTP server, SQLite/PostgreSQL support, fetch API, streams, FFI, YAML/JSON, so on. That is our goal[archive/assets/messages/attachment_1465041254214668428](archive/assets/messages/attachment_1465041254214668428)
>
...
_Ether (ethpr, `1049816501567373383`)_
> The new NA1 logo:[archive/assets/messages/attachment_1464743521872515124](archive/assets/messages/attachment_1464743521872515124)
>

<DateDisplay timestamp="1769292105870" />  
_Ether (ethpr, `1049816501567373383`)_
> @everyone introducing the new altare logo[archive/assets/messages/attachment_1464741997167513763](archive/assets/messages/attachment_1464741997167513763)
> [archive/assets/messages/attachment_1464741997628756019](archive/assets/messages/attachment_1464741997628756019)
>
...
_Ether (ethpr, `1049816501567373383`)_
> praise our lord and savior hat[archive/assets/messages/attachment_1464350422108995684](archive/assets/messages/attachment_1464350422108995684)
>
